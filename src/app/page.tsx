          ...
          >
            ...
            <motion.div variants={itemFade} className="flex flex-wrap gap-5">
              ...
              <a
                ...
                className="px-10 py-5 rounded-full bg-brand-green text-white flex items-center gap-3 font-sans font-bold hover:shadow-lg shadow-brand-green/20 transition-all duration-300 cursor-pointer"
              >
            ...
            <div className="mt-12 pt-8 border-t border-white/20 flex flex-col gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  ...
                  >
                    <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.67-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.076 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.569-.347m-5.421-7.403h-.004a9.87 9.87 0 00-4.992 1.327 9.776 9.776 0 00-2.924 2.914 9.74 9.74 0 00-.043 12.247c.832 1.206 1.937 2.29 3.175 3.072l-1.341 4.902a.996.996 0 001.294 1.224l4.872-1.462a9.777 9.777 0 004.951.628 9.768 9.768 0 009.384-9.778 9.769 9.769 0 00-9.269-9.724zm0-2.382c1.734 0 3.433.361 5.031 1.059l3.582-1.078a.996.996 0 011.291 1.219l-1.074 3.928a9.77 9.77 0 012.779 7.04 9.77 9.77 0 01-9.772 9.769c-1.733 0-3.432-.361-5.031-1.059l-3.583 1.078a.996.996 0 01-1.291-1.219l1.074-3.928a9.77 9.77 0 01-2.779-7.04 9.77 9.77 0 019.772-9.769z" />
                  </svg>
                </a>
                <a
            ...
            <form className="flex flex-col gap-6">
              <div className="flex flex-col md:flex-row gap-6">
                <input
                  ...
                  className="flex-1 px-6 py-4 bg-slate-50 border border-slate-100 rounded-2xl focus:outline-brand-green"
                />
                <input
                  type="email"
                  placeholder="Email"
              ...
              <textarea
                ...
                className="h-32 px-6 py-4 bg-slate-50 border border-slate-100 rounded-2xl focus:outline-brand-green resize-none"
              ></textarea>
              <button className="bg-brand-green text-white font-bold py-4 px-8 rounded-2xl hover:shadow-lg shadow-brand-green/20 transition-all flex items-center justify-center gap-3 cursor-pointer">
                Kirim Sekarang →
              </button>
            </form>
          </div>
